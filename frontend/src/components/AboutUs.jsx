...
import { FaFacebook, FaInstagram, FaLinkedin, FaPaperPlane, FaQuoteLeft, FaTwitter, FaYoutube } from 'react-icons/fa'
        ...
        <div className="aboutUsBottom">
          ...
          <div className="aboutUsBottomRight">
            ...
            <div className="aboutUsBottomTexts">
              ...
              <span>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reprehenderit, fugiat! Iste error cumque, earum debitis enim maiores </span>
            </div>
      ...
      <div className="aboutUsOthers">
        ...
        <div className="aboutUsImagesDiv">
          ...
          <div className="aboutUsImgDiv">
            <h4>Synther Vaporwere</h4>
            <span>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Debitis iure sed error, nemo dolor explicabo? Illum vitae ratione repellat iusto totam?</span>
