                    ...
                    <div className="introRightContent">
                        <div className="introRightInner">
                            <div className="introRightText">
                                <h3 className="introRightTitle">Woomen</h3>
                                <p className="introRightDesc">Best Clothes for Woomen</p>
                            </div>
                            <img src="./assets/uploads/baner-right-image-01.jpg" alt="" />
                        </div>
                        <div className="introRightHover">
                            <div className="introRightHoverTexts">
                                <h3 className="introRightTextTitle">Woomen</h3>
                    ...
                    <div className="introRightContent">
                        <div className="introRightInner">
                            <div className="introRightText">
                                ...
                                <p className="introRightDesc">Best Trends for Accessories</p>
                            </div>
