        ...
        <div className='latestContainer'>
            <div className="latestDiv">
                ...
                <div className="latestText">
                    <h3 className="latestTitle">Mens Latest</h3>
                        ...
                        <Slider {...settings}>
                            ...
                            <div className='sliderImgDiv'>
                                <div className="sliderImgTop">
                                    ...
                                    <div className="sliderImgTopInner">
                                        <img src='./assets//uploads/men-01.jpg' alt='' className="sliderImage"></img>
                                    </div>
                            ...
                            <div className='sliderImgDiv'>
                                <div className="sliderImgTop">
                                    ...
                                    <div className="sliderImgTopInner">
                                        <img src='./assets//uploads/men-02.jpg' alt='' className="sliderImage"></img>
                                    </div>
